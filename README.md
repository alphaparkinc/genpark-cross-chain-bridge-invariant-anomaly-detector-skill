# genpark-cross-chain-bridge-invariant-anomaly-detector-skill
...
**genpark-cross-chain-bridge-invariant-anomaly-detector-skill** is a deterministic, zero-dependency Python skill engineered for autonomous smart contract auditing, callgraph verification, signature phishing defense, and DeFi vulnerability triage.

> **Executive Capability**: Cross-chain bridge token reserve invariant auditor & outflow spike monitor (LayerZero / Wormhole)
...
result = client.detect_bridge_reserve_anomalies()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-cross-chain-bridge-invariant-anomaly-detector-skill": {
      "command": "python",
      "args": ["/path/to/genpark-cross-chain-bridge-invariant-anomaly-detector-skill/mcp_server.py"]
    }
  }
}
```
